...
export const translations = {
  de: {
    ...
    booking: {
      ...
      codeLabel: "Gutscheincode (optional)",
      codePh: "z. B. HERBST25",
      codeChecking: "Code wird geprüft …",
      codeRemaining: "Noch {n} von {max} Plätzen",
      codeInvalid: "Der Gutscheincode ist ungültig.",
      codeSoldOutSwitch: "Die Aktion ist inzwischen ausgebucht. Bitte ohne Code buchen.",
      codeErrors: {
      ...
      errTime: "Bitte wähle eine Uhrzeit.",
      availabilityError:
      ...
      submitFailed: "Buchung fehlgeschlagen. Bitte später erneut versuchen.",
      treatments: [
    ...
    treatmentPage: {
      eyebrow: "Behandlung",
      durations: "Dauer & Preise",
      durationsHint: "Wähle deine Wunschdauer direkt im Buchungsfenster.",
      book: "Jetzt online buchen",
      minutes: "Min.",
      hoursTitle: "Öffnungszeiten",
      address: "Adresse",
      openMaps: "In Google Maps öffnen →",
      voices: "Stimmen aus dem Studio",
      notFoundH: "Behandlung nicht gefunden",
      notFoundP: "Diese Behandlung gibt es hier nicht (mehr).",
      toStudio: "Zur Studio-Startseite",
      overviewEyebrow: "Treatments",
      overviewH: "Unsere Behandlungen.",
      overviewLink: "Details ansehen",
      from: "ab",
    },
  },
  en: {
    ...
    booking: {
      ...
      codeLabel: "Voucher code (optional)",
      codePh: "e.g. HERBST25",
      codeChecking: "Checking code …",
      codeRemaining: "{n} of {max} spots left",
      codeInvalid: "The voucher code is invalid.",
      codeSoldOutSwitch: "This offer is now fully booked. Please book without a code.",
      codeErrors: {
        unbekannt: "Unknown code",
        abgelaufen: "Offer expired",
        ausgebucht: "Offer fully booked",
        andere_behandlung: "Code is valid for a different treatment",
        nur_neukunden: "Code is valid for first bookings only",
      },
      errDate: "Please choose a date.",
      errTime: "Please choose a time.",
      availabilityError:
        "Availability could not be loaded. Please reload the page or contact us by phone.",
      reselectTime:
        "Please select a time again – the available times changed with the new duration.",
    ...
    treatmentPage: {
      eyebrow: "Treatment",
      durations: "Durations & prices",
      durationsHint: "Pick your preferred duration in the booking window.",
      book: "Book online now",
      minutes: "min",
      hoursTitle: "Opening hours",
      address: "Address",
      openMaps: "Open in Google Maps →",
      voices: "Voices from the studio",
      notFoundH: "Treatment not found",
      notFoundP: "This treatment is not available here (anymore).",
      toStudio: "To the studio home page",
      overviewEyebrow: "Treatments",
      overviewH: "Our treatments.",
      overviewLink: "View details",
      from: "from",
    },
  },
} as const;
